...
// (已修改) 在這裡添加了第四個參數 'siteMemoNumber'
export const generateDefectLogPDF = async (defects, projectTitle = 'All Projects', filterType = 'All', siteMemoNumber = 'N/A') => {
  try {
  	const now = new Date();
...
  	  	  	<div class="info-row">
  	  	  	  <div class="info-label">Site Memo No:</div>
  	  	  	  <div class="info-value"><strong>${siteMemoNumber}</strong></div>
  	  	  	</div> 
  	  	  	
  	  	  	  	  	  	<div class="info-row">
...
  	  	  	<p><strong>Building Services Inspection App</strong></p>
  	  	  	<p>Generated on ${dateStr} at ${timeStr}</p>
s   	  	  	<p>This report analyzes ${defects.length} defect record(s)</p>
  	  	  </div>
  	  	</body>
  	  </html>
  	`;
